...
\begin{figure}[htbp] % htbp suggests placement preference: here, top, bottom, page
    ...
    \begin{tikzpicture}[
        ...
        root_node/.style={base_node, fill=red, text=white}, % Restored original root node style
...
\begin{algorithm}
    ...
    \begin{algorithmic}[1]
        ...
        \State $r \gets x$
        \If{$l \le r$} \Comment{Ensure interval is valid}
