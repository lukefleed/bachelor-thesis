...
\section{Bitvectors}\todo[]{Maybe call this section "RRR: A succint data structure for rank and select" or something like that} \label{sec:bitvectors}
...
\]
\todo{Maybe talk about monoids and how rank and select are inverses of each other} \vspace{0.4cm}
