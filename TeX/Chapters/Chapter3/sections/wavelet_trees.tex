...
% \noindent The wavelet tree was introduced in 2003 by Grossi, Gupta, and Vitter \cite{GrossiWT2003}. It is are a self-indexing rank and select data structure, i.e., it can answer rank and select queries, while still allowing to access the text. This makes them a powerful tool for compressed full-text indices such as the FM-index \cite{ferragina2000opportunistic}, where they are used to answer rank queries during the backward search. \vspace{0.4cm}
