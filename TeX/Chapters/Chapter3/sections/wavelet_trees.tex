...
\begin{example}[Access on a wavelet tree]
    ...
    \noindent We can now build the wavelet tree for this sequence\todo{TODO: align chars with bits in the nodes of the wt}, assigning the bitmaps to each node. Figure \ref{fig:wavelet_tree_example} shows the wavelet tree for the sequence. \\
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
        ...
        child {node[align=center] {TODO\\TODO}}
        child {node[align=center] {TODO\\TODO}
                child {node[align=center] {TODO\\TODO}}
                child {node[align=center] {TODO\\TODO}}
            };
