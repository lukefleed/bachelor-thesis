...
\begin{example}[Morse Code]\label{ex:morse_code}
    \todo[inline]{TODO from \cite{ElementsofInformationTheory}}
\end{example}
...
\todo[inline]{Add some introduction from \cite{ElementsofInformationTheory,Shannon1948,KolmogorovComplexity,han2002mathematics}} \vspace{0.4cm}
