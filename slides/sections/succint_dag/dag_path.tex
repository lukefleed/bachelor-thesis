...
\begin{frame}{$\mathcal{O}$-Set Construction Example}
    ...
    \begin{figure}[hbtp]
        ...
        \only<1>{\includegraphics[width=0.9\textwidth]{assets/dag_explicit1.pdf}}
        \only<2>{\includegraphics[width=0.9\textwidth]{assets/dag_explicit2.pdf}}
        \only<3>{\includegraphics[width=0.9\textwidth]{assets/dag_explicit3.pdf}}
        \only<4>{\includegraphics[width=0.9\textwidth]{assets/dag_explicit4.pdf}}
        \only<5>{\includegraphics[width=0.9\textwidth]{assets/dag_explicit5.pdf}}
        \only<6>{\includegraphics[width=0.9\textwidth]{assets/dag_explicit6.pdf}}
        \only<7>{\includegraphics[width=0.9\textwidth]{assets/dag_explicit7.pdf}}
        \only<8>{\includegraphics[width=0.9\textwidth]{assets/dag_explicit8.pdf}}
        \only<9>{\includegraphics[width=0.9\textwidth]{assets/dag_explicit_final.pdf}}
    \end{figure}
    % \begin{figure}[h!]
    %     \centering
