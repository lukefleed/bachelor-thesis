...
\begin{frame}{The Subset Membership Problem}
    ...
    % Problema centrale introdotto in modo diretto e semplice
...
% QUESTA È LA TUA SLIDE 6 ORIGINALE, ORA SLIDE 5, con stile rivisto in precedenza
...
% QUESTA È LA TUA SLIDE 2 ORIGINALE (COMBINATA), ORA SLIDE 6, con stile rivisto in precedenza
